...
void main() {
    ...
    Cafenea cafenea_new = initializareCafenea("Starbucks", 25, 43);
    ...
    printf("Cafeneaua cu densitate minima: %s\n", numeMinim);

    afisareCafenele(cap);

    inserareFinal(&cap, cafenea_new);
    ...
    free(cafenea3.nume);
    cafenea3.nume = NULL;
    free(cafenea_new.nume);
    cafenea_new.nume = NULL;
